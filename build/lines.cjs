...
case 4:
    ...
    this.$ = {type:'INDENT', val: yyvstack[yysp].length, loc: toLoc(yyloc)}
    break;
...
case 5:
    ...
    this.$ = {type:'PIPE', loc: toLoc(yyloc)}
    break;
...
case 6:
    ...
    // log('token', yy.token);
    // log('describeSymbol', yy.parser.describeSymbol());
    this.$ = {type:'KEYWORD', val: yyvstack[yysp], loc: toLoc(yyloc)}
    break;
...
case 7:
    ...
    this.$ = {type:'NOT_INDENT', val: yyvstack[yysp], loc: toLoc(yyloc)}
    break;

case 8:
    /*! Production::    line : DEDENT */
    ...
    this.$ = {type:'DEDENT', loc: toLoc(yyloc)}
    break;
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 6:
        /*! Conditions:: INITIAL */
        /*! Rule::       ^({space}{space}|\t)+ */
        debug('\n>>>>>>\n2 yy_.yyleng', yy_.yyleng);

        // log('yy.lexer.conditionStack', yy.lexer.conditionStack); 
        debug('2 yy_.yytext', yy_.yytext);

        debug('2 yy_.yytext.search(/\\s/)', yy_.yytext.search(/\s/));
        var indentation = yy_.yyleng; //yy_.yyleng - yy_.yytext.search(/\s/) ;
