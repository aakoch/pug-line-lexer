...
case 2:
    ...
    yyvstack[yysp - 1].push(yyvstack[yysp]); this.$ = yyvstack[yysp - 1]; console.log('lines line: ', yyvstack[yysp - 1]);
    break;
...
case 4:
    ...
    console.log('KEYWORD', this.$); this.$ = {type:'KEYWORD', value:this.$}
    break;
...
case 5:
    ...
    console.log('TAG', this.$); this.$ = {type:'TAG', value:this.$}
    break;

case 6:
    /*! Production::    line : TAG LPAR ANYTHING RPAR */
...
case 8:
    ...
    this.$ = {type:'SPACE', value:yyvstack[yysp]}
    break;

case 9:
    /*! Production::    line : ANYTHING */

    this.$ = {type:'ANYTHING', value:yyvstack[yysp]}
    break;
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  ...
  exports.parse = function () {
    return lines.parse.apply(lines, arguments);
  };
