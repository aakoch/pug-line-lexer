...
test("doctype html", { type: 'doctype', type: 'html' })
...
test("<TEXT_START>window.dataLayer = window.dataLayer || [];   ", { type: 'text', text: 'window.dataLayer = window.dataLayer || [];   ' })
test("<TEXT_START>gtag('config', 'UA-452464-5');", {"type":"text","text":"gtag('config', 'UA-452464-5');"})
test("", "")
test("script test", {"type":"tag","name":"script","therest":"test"})
test("tag", { type: 'tag', name: 'tag' })
test(".classname", { type: 'classname', name: 'classname' })
test("// some text", { type: 'comment' })
test("// ", { type: 'comment' })
// test("//", { type: 'comment' })
