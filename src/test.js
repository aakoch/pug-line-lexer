...
case 2:
    /*! Production::    prog : id_list ENDOFFILE */
...
case 3:
    /*! Production::    id_list : id_list block */

    yyvstack[yysp - 1].push([yyvstack[yysp]]); this.$ = yyvstack[yysp - 1];  console.log("id_list=%s block=%s", JSON.stringify(yyvstack[yysp - 1]), yyvstack[yysp]);
    break;

case 4:
    /*! Production::    id_list : block */

    this.$ = [yyvstack[yysp]]; console.log("block=%s", yyvstack[yysp]);
    break;

case 5:
    /*! Production::    block : block EOF */

    this.$ = [yyvstack[yysp - 1]]; console.log('block EOF'); console.log(_iemitstack)
    break;
...
case 6:
    ...
    console.log('ID=%s', yyvstack[yysp]); console.log(_iemitstack)
    break;
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 18:
        ...
        // console.log('yy_.yyleng=%d', yy_.yyleng)
        // console.log('yy_.yytext=%s', yy_.yytext)
