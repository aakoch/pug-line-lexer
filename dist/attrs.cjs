...
symbols_: {
  ...
  "attr_option": 32,
  "attr_repetition": 33,
  "attr_repetition_plus": 31,
  "attrs": 22,
  "error": 2,
  "key_value_pair": 27,
  "key_value_pair_repetition": 34,
  "key_value_pair_repetition2": 35,
  "key_value_pairs": 26,
  "list": 28,
  "list_item": 29,
  "list_item_option": 36,
...
case 19:
    /*! Production::    key_value_pair : KEY_VAL */
case 20:
    /*! Production::    key_value_pair : KEY_DIG */
case 28:
    /*! Production::    spaces : SPACE */
...
case 27:
    /*! Production::    spaces : spaces SPACE */
...
case 3:
    /*! Production::    attrs : attrs SPACE attr */
case 5:
    /*! Production::    attrs : attrs COMMA attr */
...
case 6:
    /*! Production::    attr : ID OP val */

    debug('attr: ID OP val: ID=', yyvstack[yysp - 2], ', OP=', yyvstack[yysp - 1], ', val=', yyvstack[yysp])
    this.$ = { key: yyvstack[yysp - 2], val: yyvstack[yysp] }
    break;

case 7:
    /*! Production::    attr : ID spaces OP val */

    debug('attr: ID OP val: ID=', yyvstack[yysp - 3], ', OP=', yyvstack[yysp - 1], ', val=', yyvstack[yysp])
    this.$ = { key: yyvstack[yysp - 3], val: yyvstack[yysp] }
    break;

case 8:
    /*! Production::    attr : ID OP ASSIGNMENT attr_repetition_plus attr_option */

    debug('attr: ID OP ASSIGNMENT VAL+: ID=', yyvstack[yysp - 4], ', OP=', yyvstack[yysp - 3], ', ASSIGNMENT=', yyvstack[yysp - 2])
    this.$ = { assignment: true, key: yyvstack[yysp - 4], val: yyvstack[yysp - 1].join('') }
    break;

case 9:
    /*! Production::    attr : ID spaces OP spaces val */

    debug('attr: ID spaces OP spaces val: ID=', yyvstack[yysp - 4], ', OP=', yyvstack[yysp - 2], ', val=', yyvstack[yysp])
    this.$ = { assignment: true, key: yyvstack[yysp - 4], val: yyvstack[yysp - 1].join('') }
    break;

case 10:
    /*! Production::    attr : ID OP VARIABLE */

    this.$ = { key: yyvstack[yysp - 2], assignment: true, val: yyvstack[yysp] }
    break;

case 11:
    /*! Production::    attr : ID OP val ASSIGNMENT attr_repetition ID */

    debug('$0=', yyvstack[yysp - 6])
    debug('attr: ASSIGNMENT SPACE* ID: ASSIGNMENT=', yyvstack[yysp - 2], ', ID=', yyvstack[yysp - 3])
    // $-1['val'] = '"' + $-1.val + '" ' + $ASSIGNMENT + $3
    this.$ = {}
    break;

case 12:
    /*! Production::    val : QUOTE VAL QUOTE */

    debug('val: VAL: VAL=', yyvstack[yysp - 1])
    this.$ = yyvstack[yysp - 1]
    break;

case 13:
    /*! Production::    val : OPEN_BRACKET list CLOSE_BRACKET */
...
case 14:
    ...
    debug('val: obj: obj=', yyvstack[yysp])
    // this could be improved...
    this.$ = _.map(_.filter(yyvstack[yysp], (obj) => _.values(obj)[0]), (obj2) => _.keys(obj2)[0]).join(' ')
    debug('val: obj: $$=', this.$)
    break;

case 15:
    /*! Production::    obj : LCURLY key_value_pairs RCURLY */

    // {foo: true, bar: false, baz: true}
    debug('$key_value_pairs=', yyvstack[yysp - 1])
    this.$ = yyvstack[yysp - 1]
...
case 16:
    /*! Production::    key_value_pairs : key_value_pairs COMMA key_value_pair */
...
case 18:
    /*! Production::    key_value_pair : KEY key_value_pair_repetition COLON key_value_pair_repetition2 VAL */
...
case 21:
    /*! Production::    key_value_pair : KEY_BOOL */

    let [key, value] = yyvstack[yysp].split(':')
    this.$ = {}
    this.$[key.trim()] = value.trim().toLowerCase() == 'true'
...
case 22:
    /*! Production::    list : list list_item */

    yyvstack[yysp - 1].push([yyvstack[yysp]].flat()[0])
    this.$ = yyvstack[yysp - 1]
    break;

case 23:
    /*! Production::    list : list_item */

    this.$ = [ yyvstack[yysp] ]
    break;

case 24:
    /*! Production::    list_item : QUOTE VAL QUOTE COMMA list_item_option */

    debug('list_item: QUOTE VAL QUOTE COMMA SPACE?: VAL=', yyvstack[yysp - 3])
    this.$ = yyvstack[yysp - 3]
    break;

case 25:
    /*! Production::    list_item : QUOTE VAL QUOTE */

    debug('list_item: QUOTE VAL QUOTE: VAL=', yyvstack[yysp - 1])
    this.$ = yyvstack[yysp - 1]
    break;

case 26:
    /*! Production::    spaces : %epsilon */
...
case 29:
    /*! Production::    attr_repetition_plus : VAL */

    this.$ = [yyvstack[yysp]];
    break;

case 30:
    /*! Production::    attr_repetition_plus : attr_repetition_plus VAL */
case 34:
    /*! Production::    attr_repetition : attr_repetition SPACE */
case 36:
    /*! Production::    key_value_pair_repetition : key_value_pair_repetition SPACE */
case 38:
    /*! Production::    key_value_pair_repetition2 : key_value_pair_repetition2 SPACE */
...
case 31:
    /*! Production::    attr_option : %epsilon */
case 39:
    /*! Production::    list_item_option : %epsilon */

    this.$ = undefined;
    break;

case 32:
    /*! Production::    attr_option : RPAREN */
case 40:
    /*! Production::    list_item_option : SPACE */

    this.$ = yyvstack[yysp];
    break;

case 33:
    /*! Production::    attr_repetition : %epsilon */
case 35:
    /*! Production::    key_value_pair_repetition : %epsilon */
case 37:
    /*! Production::    key_value_pair_repetition2 : %epsilon */
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 3:
        /*! Conditions:: AFTER_OP OBJ_STARTED */
        /*! Rule::       \} */
        this.popState();
      ...
      case 8:
        ...
        debug('quote started with "' + yy_.yytext + '"');
      ...
      case 12:
        /*! Conditions:: QUOTE_STARTED_WITH_SINGLE */
        /*! Rule::       ' */
        this.popState();
      ...
      case 14:
        /*! Conditions:: QUOTE_STARTED_WITH_DOUBLE */
        /*! Rule::       " */
        this.popState();
    ...
    simpleCaseActionClusters: {
      ...
      /*! Conditions:: OBJ_STARTED */
      /*! Rule::       , */
      15: 4,

      /*! Conditions:: OBJ_STARTED */
      /*! Rule::       {quote}?([^\:\'\"]+){quote}?{space}*:{space}*{quote}([^\'\"]+){quote}? */
      16: 17,

      /*! Conditions:: OBJ_STARTED */
      /*! Rule::       {quote}?([^\:\'\"]+){quote}?{space}*:{space}*(\d+) */
      17: 18,

      /*! Conditions:: OBJ_STARTED */
      /*! Rule::       {quote}?([^\:\'\"]+){quote}?{space}*:{space}*(true|false) */
      18: 19,
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = parseAttrs;
  exports.Parser = parseAttrs.Parser;
  exports.parse = function () {
    return parseAttrs.parse.apply(parseAttrs, arguments);
  };
