...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 63 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 16:
        ...
        return 22; // only because it is an empty object 
        break;
    ...
    conditions: {
      ...
      'AFTER_TAG_NAME': {
        rules: [19, 20, 21, 27, 28, 30, 31, 33, 34],
        inclusive: false
      },
      ...
      'INITIAL': {
        rules: [0, 1, 2, 3, 4, 5, 6, 10, 11, 12, 13, 14, 15, 16, 17, 18, 29, 36],
        inclusive: true
      },
