...
case 47:
    /*! Production::    line_splitter : RPAREN */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 58 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 15:
        ...
        return 21; // only because it is an empty object 
        break;
    ...
    rules: [
      /*  0: */  /^(?:((append|block|case|default|doctype|each|else|extends|if|include|mixin|unless|when)\b))/i,
    ...
    conditions: {
      ...
      'INITIAL': {
        rules: [0, 1, 2, 3, 4, 5, 6, 9, 10, 11, 12, 13, 14, 15, 25, 32],
        inclusive: true
      },
