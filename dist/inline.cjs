...
case 13:
    /*! Production::    line_parts : line_part */
...
case 12:
    /*! Production::    line_parts : line_parts line_part */
case 18:
    /*! Production::    opening_tag : TAG_START TAG_START_END */
...
case 3:
    ...
    if (typeof yyvstack[yysp] === 'string' && yyvstack[yysp].length == 0) {
      this.$ = yyvstack[yysp - 1]
    }
    else {
      this.$ = [yyvstack[yysp - 1]].flat()
...
case 8:
    /*! Production::    words : word */

    this.$ = [yyvstack[yysp]]
    break;

case 5:
    /*! Production::    line_part : words */

    this.$ = { type: 'text', val: yyvstack[yysp].flat().join('') }
    break;

case 7:
    /*! Production::    words : words word */
...
case 10:
    ...
    debug('WORD: WORD=', yyvstack[yysp])
    this.$ = [yyvstack[yysp]]
    break;

case 11:
    /*! Production::    word : PUNC */

    debug('PUNC: PUNC=', yyvstack[yysp])
    this.$ = [yyvstack[yysp]]
    break;

case 14:
    /*! Production::    tag : opening_tag line_part TAG_END */

    debug('opening_tag line_part TAG_END: opening_tag=', yyvstack[yysp - 2], ', line_part=', yyvstack[yysp - 1])
    if (yyvstack[yysp - 1].type === 'text') {
      this.$ = { type: 'tag', name: yyvstack[yysp - 2], children: [yyvstack[yysp - 1]] }
    }
    else {
      this.$ = { type: 'tag', name: yyvstack[yysp - 2], val: yyvstack[yysp - 1] }
    }
    break;

case 15:
    /*! Production::    tag : opening_tag line_part line_parts TAG_END */

    debug('opening_tag line_part line_parts TAG_END: opening_tag=', yyvstack[yysp - 3], ', line_part=', yyvstack[yysp - 2], ', line_parts=', yyvstack[yysp - 1])
    // if ($line_part.type === 'text') {
    //   $$ = { type: 'tag', name: $opening_tag, children: [$line_part] }
    // }
    // else {
      this.$ = { type: 'tag', name: yyvstack[yysp - 3], children: [yyvstack[yysp - 2], yyvstack[yysp - 1]] }
    // }
    break;

case 16:
    /*! Production::    tag : opening_tag TAG_END */

    this.$ = { type: 'tag', name: yyvstack[yysp - 1] }
    break;

case 17:
    /*! Production::    tag : TAG_SELF_CLOSING */

    this.$ = { type: 'tag', name: yyvstack[yysp] }
    break;
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 2:
        /*! Conditions:: AFTER_TAG_START_END */
        /*! Rule::       <\/\s*(\w+)\s*> */
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = inlineParser;
  exports.Parser = inlineParser.Parser;
  exports.parse = function () {
    return inlineParser.parse.apply(inlineParser, arguments);
  };
