...
case 41:
    ...
    debug('Calling parseAttrs with ', yyvstack[yysp - 1])
    const attrs = parseAttrs.parse(yyvstack[yysp - 1])
    debug('attrs=', attrs)
    this.$ = {}
    attrs.forEach(attr => {
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      case 16:
        ...
        return 24; // only because it is an empty object 
        break;
    ...
    conditions: {
      ...
      'AFTER_TAG_NAME': {
        rules: [19, 20, 22, 29, 30, 32, 33, 34, 36, 37],
        inclusive: false
      },
      ...
      'AFTER_TEXT_TAG_NAME': {
        rules: [22, 32, 33, 34, 36, 37],
        inclusive: false
      },

      'AFTER_KEYWORD': {
        rules: [21, 32, 33, 34, 37],
        inclusive: false
      },
      ...
      'INITIAL': {
        rules: [0, 1, 2, 3, 4, 5, 6, 10, 11, 12, 13, 14, 15, 16, 17, 18, 24, 31, 39],
        inclusive: true
      },
